...
import { FaEnvelope, FaPhone, FaBriefcase, FaEdit } from "react-icons/fa"

const UserCard = ({ user }) => {
    return (
        <div className="my-4 py-8 bg-white rounded-lg shadow-md overflow-hidden max-w-md mx-auto mt-8 relative">
          {/* Edit Button */}
          <Link
            className="absolute top-4 right-4 text-[#3d5a6c] hover:text-[#72a98f] focus:outline-none"
            to = "/profile/edit"
          >
            <FaEdit size={24} />
          </Link>
